/*
 * Si4703_Breakout_C.c
 * Upravená verze pro lepší stabilitu na SMD/Clone deskách
 */
...
void si4703_init(void) {
    ...
    // ZVĚTŠENO: Dlouhé čekání na vybití a ustálení (původně 1ms)
    _delay_ms(20); 
    ...
    // Hlasitost na minimum při startu (aby to "nebouchlo")
...
void si4703_setChannel(uint16_t channel) {
    ...
    // Přidán timeout counter pro jistotu, aby se nezacyklil
    uint16_t timeout = 0;
    while(1) {
        si4703_readRegisters();
