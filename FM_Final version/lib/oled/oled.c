...
/**
 * @file oled.c
 * @brief Implementace knihovny pro OLED displej.
 * * Obsahuje nízkoúrovňovou komunikaci (I2C/SPI), inicializační sekvence
 * a implementaci grafických algoritmů (Bresenham pro čáry a kružnice).
 *
 * @author Michael Köhler (Skie-Systems) - Původní autor kódu
 * @author AI Assistant (Gemini) - Dokumentace
 */
...
// Interní proměnné pro stav kurzoru
static struct {
    uint8_t x;
    uint8_t y;
} cursorPosition;
...
# include <stdlib.h>
// Frame buffer pro grafický režim (celá obrazovka v RAM)
// 128 * 64 / 8 = 1024 bytů
...
// Inicializační sekvence pro SSD1306/SH1106
